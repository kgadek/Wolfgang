...
public class User {
    ...
    public User setLogin(String newLogin) {
        ...
        if(newLogin.equals(login))
            return this;
        User ret = new User(id, newLogin, lastLogin, DataMaster.bytesToString(passwordHash));
        return ret;
    }
    ...
    public User setPassword(String newPassword) throws NoSuchAlgorithmException {
        ...
        DataMaster.logger.finest("SHA256("+newPassword+") = "+DataMaster.bytesToString(newPasswordHash));
